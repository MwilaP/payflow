...
export function PayrollStructureForm({ id }: PayrollStructureFormProps = {}) {
  ...
  return (
    <div className="grid gap-6 md:grid-cols-3">
      <div className="space-y-6 md:col-span-2 overflow-y-auto" style={{ maxHeight: 'calc(100vh - 8rem)' }}>
      ...
      <div className="md:col-span-1">
        <div className="sticky top-6" style={{ maxHeight: 'calc(100vh - 8rem)', overflowY: 'auto' }}>
