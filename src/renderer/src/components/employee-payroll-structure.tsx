                  ...
                  <Table>
                    ...
                    <TableBody>
                        ...
                        <TableRow key={allowance._id || allowance.name}>
                          ...
                          <TableCell className="text-right">
                            {allowance.type === 'percentage'
                              ? `${allowance.value}%`
                              : `K${allowance.value.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                          </TableCell>
                          <TableCell className="text-right">
                            K
                      ...
                      <TableRow className="font-medium">
                        ...
                        <TableCell className="text-right">
                          K
                          {details.grossPay.toLocaleString(undefined, {
                            minimumFractionDigits: 2,
                            maximumFractionDigits: 2
                          })}
                        </TableCell>
                        ...
                        <TableRow key={deduction._id || deduction.name}>
                          ...
                          <TableCell className="text-right">
                            {deduction.type === 'percentage'
                              ? `${deduction.value}%`
                              : `K${deduction.value.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`}
                          </TableCell>
                          <TableCell className="text-right">
                            K
              ...
              <div className="mt-6 rounded-lg border p-4">
                <div className="flex items-center justify-between">
                  ...
                  <p className="text-2xl font-bold">
                    K
                    {details.netPay.toLocaleString(undefined, {
                      minimumFractionDigits: 2,
                      maximumFractionDigits: 2
                    })}
                  </p>
